...
func (osp *ObjectStorageProxy) fakeIncomingRequest(req *http.Request, signer *signer_v4.Signer, region string) (*http.Request, error) {
	...
	if err := osp.signWithTime(fakeReq, signer, region, signTime); err != nil {
		return nil, err
	}
